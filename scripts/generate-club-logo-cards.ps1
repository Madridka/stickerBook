param(
  [string]$SourcePath = 'src/data/clubsLogo/spain/la-liga/cards.json',
  [string]$TemplatePath = 'public/clubsLogo/template.png',
  [string]$LogoDirectory = 'public/clubsLogo/logos/spain/la-liga',
...
$temporaryRoot = Join-Path $projectRoot 'tmp/clubsLogo'
