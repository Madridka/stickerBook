...
const PACK_ALBUMS: Readonly<Record<string, readonly string[]>> = {
  standard: ['wc-26'],
  mixed: ['wc-26', 'tomsk', 'ucl-26-27', 'spainClubsLogo'],
  kdv: ['tomsk'],
  ucl: ['ucl-26-27'],
  'spain-logos': ['spainClubsLogo'],
}
const DEFAULT_PACK_BY_ALBUM: Readonly<Record<string, string>> = {
  'wc-26': 'standard',
  tomsk: 'kdv',
  'ucl-26-27': 'ucl',
  spainClubsLogo: 'spain-logos',
}
