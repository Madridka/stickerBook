...
/** Все стоимости покупаемых блистеров в игровых монетах. */
export const BLISTER_PRICES = {
  mixed: 40,
  standard: 30,
  kdv: 50,
  ucl: 20,
...
/** Стоимость стандартного пака; сохранено как публичный алиас. */
export const PACK_PRICE: number = BLISTER_PRICES.standard
...
export const BLISTER_CONFIGS = {
  ...
  spainLogos: {
    ...
    cost: BLISTER_PRICES.spainLogos,
    cardsPerPack: 5,
    cooldownMs: 0,
  ...
  russiaLogos: {
    ...
    cost: BLISTER_PRICES.russiaLogos,
    cardsPerPack: 5,
    cooldownMs: 0,
  ...
  englandLogos: {
    ...
    cost: BLISTER_PRICES.englandLogos,
    cardsPerPack: 5,
    cooldownMs: 0,
...
/** Обычные пики стоят один жетон, премиальные гарантируют неповторку. */
export const PICK_SHOP_OFFERS: readonly PickShopOffer[] = [
  {
    ...
    cost: PICK_SHOP_CONFIG.standardPickCost,
  ...
  },
  {
    ...
    kind: 'random',
    tier: 'premium',
    cost: BLISTER_CONFIGS.mixed.cost,
    titleKey: 'shop.picks.random.title',
    descriptionKey: 'shop.picks.random.description',
    priority: 150,
    guaranteedNew: true,
