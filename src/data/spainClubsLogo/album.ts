...
sections.forEach((section): void => {
  ...
  for (let sectionPageIndex = 0; sectionPageIndex < sectionPageCount; sectionPageIndex += 1) {
    ...
    pages.push({
      id: `spain-clubs-logo-${pageNumber}`,
      number: pageNumber,
...
const spainClubsLogoAlbum: AlbumGeometryData = {
  id: 'spainClubsLogo',
  stickerRatio: { width: 2, height: 3 },
  pages,
}

export default spainClubsLogoAlbum
